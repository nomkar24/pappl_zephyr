...
// --- IPP accessors (all platforms including Zephyr) ---
...
extern size_t		papplClientGetForm(pappl_client_t *client, cups_option_t **form) _PAPPL_PUBLIC;
...
extern bool		papplClientIsValidForm(pappl_client_t *client, size_t num_form, cups_option_t *form) _PAPPL_PUBLIC;
...
// --- Web UI (browser-facing HTML) — not built on Zephyr ---
#  ifndef __ZEPHYR__
