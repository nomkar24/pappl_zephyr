...
//
// Zephyr port: gid_t replaced; web-UI/auth-scheme functions guarded.
//
...
// --- Web UI private helpers — not built on Zephyr ---
#  ifndef __ZEPHYR__
...
// Zephyr: no POSIX groups — gid_t replaced with unsigned int (always 0 on single-user target)
extern http_status_t	_papplClientIsAuthorizedForGroup(pappl_client_t *client, bool allow_remote, const char *group, unsigned int groupid) _PAPPL_PUBLIC;
